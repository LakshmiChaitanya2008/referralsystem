...
const path = resolve(dirname(fileURLToPath(import.meta.url)), "../src/components/ReferralTreeNode.jsx");
...
const lines = [
  ...
  '        <motion className="flex items-center justify-between gap-2">',
...
const openDiv = "<" + "div";
const closeDiv = "</" + "motion>";
const content = lines
  .join("\n")
  .replaceAll("<motion", openDiv)
  .replaceAll("</motion>", "</" + "div>");

writeFileSync(path, content, "utf8");
console.log("Fixed ReferralTreeNode.jsx");
